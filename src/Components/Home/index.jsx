    ...
    return (
        <div className={styles.home}>
            <div className={styles.home_content}>
                ...
                <p>
                    Somos uma agência especializada na criação de sites e plataformas digitais para empresas,
                    focada em projetar, desenvolver e gerenciar soluções profissionais para a web.
                </p>
